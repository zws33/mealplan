...
const recipes: Recipe[] = [
    ...
    ingredients: [
      {
        ...
        quantity: {unit: 'grams', scalar: 200},
      },
      {
        ingredient: {id: 2, name: 'Ground Beef'},
        quantity: {unit: 'grams', scalar: 150},
      },
      {
        ingredient: {id: 3, name: 'Tomato Sauce'},
        quantity: {unit: 'cups', scalar: 1},
      },
      {
        ingredient: {id: 4, name: 'Onion'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
        ingredient: {id: 5, name: 'Garlic'},
        quantity: {unit: 'cloves', scalar: 2},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        ingredient: {id: 7, name: 'Lettuce'},
        quantity: {unit: 'cups', scalar: 2},
      },
      {
        ingredient: {id: 8, name: 'Tomato'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 11, name: 'Ground Beef'},
        quantity: {unit: 'grams', scalar: 200},
      },
      {
        ingredient: {id: 12, name: 'Taco Shells'},
        quantity: {unit: 'units', scalar: 4},
      },
      {
        ingredient: {id: 13, name: 'Cheese'},
        quantity: {unit: 'grams', scalar: 50},
      },
      {
        ingredient: {id: 14, name: 'Lettuce'},
        quantity: {unit: 'cups', scalar: 1},
      },
      {
        ingredient: {id: 15, name: 'Salsa'},
        quantity: {unit: 'cups', scalar: 0.5},
      },
    ],
    instructions: [
      {description: 'Brown ground beef in a pan.'},
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 16, name: 'Broccoli'},
        quantity: {unit: 'cups', scalar: 2},
      },
      {
        ingredient: {id: 17, name: 'Carrot'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
        ingredient: {id: 18, name: 'Bell Pepper'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
      ...
      },
      {
        ...
        quantity: {unit: 'tablespoons', scalar: 1},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 21, name: 'Flour'},
        quantity: {unit: 'cups', scalar: 1},
      },
      {
        ingredient: {id: 22, name: 'Milk'},
        quantity: {unit: 'cups', scalar: 1},
      },
      {
        ingredient: {id: 23, name: 'Egg'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
        ingredient: {id: 24, name: 'Baking Powder'},
        quantity: {unit: 'teaspoons', scalar: 1},
      },
      {
        ingredient: {id: 25, name: 'Sugar'},
        quantity: {unit: 'tablespoons', scalar: 1},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 26, name: 'Bread'},
        quantity: {unit: 'slices', scalar: 2},
      },
      {
        ingredient: {id: 27, name: 'Cheese'},
        quantity: {unit: 'slices', scalar: 2},
      },
      {
        ingredient: {id: 28, name: 'Butter'},
        quantity: {unit: 'tablespoons', scalar: 1},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        ingredient: {id: 30, name: 'Coconut Milk'},
        quantity: {unit: 'cups', scalar: 1},
      },
      {
      ...
      {
        ingredient: {id: 32, name: 'Onion'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
        ingredient: {id: 33, name: 'Garlic'},
        quantity: {unit: 'cloves', scalar: 2},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 34, name: 'Beef'},
        quantity: {unit: 'grams', scalar: 300},
      },
      {
        ingredient: {id: 35, name: 'Potato'},
        quantity: {unit: 'units', scalar: 2},
      },
      {
        ingredient: {id: 36, name: 'Carrot'},
        quantity: {unit: 'units', scalar: 2},
      },
      {
        ingredient: {id: 37, name: 'Onion'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
        ingredient: {id: 38, name: 'Beef Broth'},
        quantity: {unit: 'cups', scalar: 2},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 39, name: 'Eggs'},
        quantity: {unit: 'units', scalar: 3},
      },
      {
        ingredient: {id: 40, name: 'Cheese'},
        quantity: {unit: 'grams', scalar: 50},
      },
      {
        ingredient: {id: 41, name: 'Bell Pepper'},
        quantity: {unit: 'units', scalar: 1},
      },
      {
        ingredient: {id: 42, name: 'Onion'},
        quantity: {unit: 'units', scalar: 0.5},
      },
      {
        ingredient: {id: 43, name: 'Butter'},
        quantity: {unit: 'tablespoons', scalar: 1},
      },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      {
        ingredient: {id: 44, name: 'Romaine Lettuce'},
        quantity: {unit: 'cups', scalar: 2},
      },
      {
        ingredient: {id: 45, name: 'Caesar Dressing'},
        quantity: {unit: 'tablespoons', scalar: 3},
      },
      {
        ingredient: {id: 46, name: 'Parmesan Cheese'},
        quantity: {unit: 'grams', scalar: 30},
      },
      {
        ingredient: {id: 47, name: 'Croutons'},
        quantity: {unit: 'cups', scalar: 1},
      },
      {
        ingredient: {id: 48, name: 'Chicken Breast'},
        quantity: {unit: 'grams', scalar: 150},
      },
    ],
    instructions: [
